...
exports.startApiListening = void 0;
...
const inputBuffer = new types_1.fileDatabase("./fileDatabases/inputBufferDB.json");
const approvalList = new types_1.fileDatabase("./fileDatabases/approvalListDB.json");
const outputBuffer = new types_1.fileDatabase("./fileDatabases/outputBufferDB.json");
const historicalLog = new types_1.fileDatabase("./fileDatabases/historicalLogDB.json");
// Support Functions:
function startApiListening(port = 3000) {
    /**
    ...
    //--Endpoints--
    //-------------
    app.post('/customer-deletions', (0, express_validator_1.body)().isArray(), (0, express_validator_1.body)("*").custom(validators_1.validateNewRequest), function (req, res) {
        /**
        ...
        (0, input_1.input_fromBuffer)(approvalList, inputBuffer);
    });
    app.put('/customer-deletions', (0, express_validator_1.body)().isArray(), (0, express_validator_1.body)("*").custom(validators_1.validateApprovalRequest), //Note: * makes this work for arrays
    async function (req, res) {
        ...
        let errorLog = [];
        const promises = approvals.map(async (request) => {
            try {
...
exports.startApiListening = startApiListening;
